...
//	    ResponseUpgrade response= null;
		if (response != null) {
			...
			try {
				...
				String q="select Number_of_shares from company_c WHERE name='"+response.getSellerName()+"'";
				...
				String r="UPDATE company_c SET Number_of_shares="+seller_shares_after+" WHERE name='"+response.getSellerName()+"'";
				...
				String s="SELECT Number_of_shares from company_c WHERE name='"+response.getBuyerName()+"'";
				...
				String t="UPDATE company_c SET Number_of_shares="+buyer_shares_after+" WHERE name='"+response.getBuyerName()+"'";
